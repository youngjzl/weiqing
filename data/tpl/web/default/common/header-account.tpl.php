...
<span class="pull-right">
	<a href="<?php  echo url('account/display', array('type' => 'all'))?>" class="color-default we7-margin-left">
		<i class="wi wi-cut-account color-default"></i>切换平台
	</a>
</span>
<?php  if($_W['role'] != ACCOUNT_MANAGE_NAME_OPERATOR) { ?>
<span class="pull-right"><a href="<?php  echo url('account/post', array('uniacid' => $_W['account']['uniacid'], 'acid' => $_W['account']['acid'], 'account_type' => $_W['account']['type']))?>">
