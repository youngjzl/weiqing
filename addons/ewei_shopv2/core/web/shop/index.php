...
class Index_EweiShopV2Page extends WebPage {
    ...
    public function ajax() {
        ...
        //分销商总数
        $commission_agent_total = pdo_fetchcolumn("select count(*) from" . tablename('ewei_shop_member') . " as  dm "
            . " where dm.uniacid =:uniacid and dm.isagent =1 and dm.status = 1", array(':uniacid' => $_W['uniacid']));

        //待审核分销商
        $commission_agent_status0_total = pdo_fetchcolumn("select count(1) from" . tablename('ewei_shop_member') . " as  dm "
