...
if ($_GPC['type'] == 1) {
	...
	$tableheader = array('rid' => 'RID','id' => 'ID', 'username' => '投票人', 'realname' => '真实姓名', 'mobile' => '手机号', 'vote_times' => '投票数', 'votetype' => '投票是否付费', 'votefrom' => '投票来源', 'fnickname' => '被投票人', 'fmobile' => '联系方式', 'anickname' => '拉票人', 'ip' => '投票IP', 'country' => '投票国家', 'province' => '投票城市', 'city' => '投票地区', 'status' => '状态', 'spstatus' => '封禁状态', 'createtime' => '投票时间');
